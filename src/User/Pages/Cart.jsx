...
export default function Cart() {
    ...
    const checkout = () => {
        ...
        axios.post('http://localhost:3000/api/order/placeOrder', payload)
            .then(json => {
    ...
    return (
        <div className="container">
            ...
            <p className="text-center text-secondary">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Mollitia eius totam nostrum voluptatibus culpa accusamus.</p>
            
            {cart_state.cart?.length > 0 ? (
                <>
                    {cart_state.cart.map((product, key) => (
                        <div className="card mb-4 d-flex bg-shadow bg-rounded" style={{width:"70vw", height:"40vh"}} key={key}>
                            <div className="row ">
                                <div className="col-md-2 d-flex justify-content-center align-items-center">
                                    <img src={product.ProductImage} alt={product.productName} className="img-fluid rounded-start" style={{ height: '25vh', objectFit: 'contain' }} />
                                </div>
                                <div className="col-md-6">
                                    <div className="card-body">
                                        <h5 className="card-title">{product.productName} - {product.price}</h5>
                    ...
                    <button className="btn btn-warning w-100" onClick={checkout}>Place Order</button>
                </>
            ) : (
